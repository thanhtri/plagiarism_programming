...
$string['use_programming'] = 'Verwenden Sie die Erkennung von Plagiaten im Quellcode.';
...
$string['moss_id_help_2'] = 'Kopieren Sie den E-Mail-Inhalt in das darunterliegende Feld';
...
$string['moss_account_instruction'] = 'Eine MOSS kann per Mail an "moss@moss.stanford.edu registriert" werden. Anweisungen dazu finden Sie bei MOSS: http://theory.stanford.edu/~aiken/moss/';
...
$string['detection_tool'] = 'Erkennungswerkzeuge';
$string['jplag'] = 'JPlag';
$string['moss'] = 'MOSS';
...
$string['manual_scheduling_help'] = 'Wenn Sie das Scannen sofort auslösen wollen (bei verspäteten Einreichungen, Erweiterung, ...), '
    .'bitte klicken Sie auf den untenstehenden Button! Beachten Sie, dass es die geplante Überprüfung nicht beeinflusst.';
